 ...
 */
public class OScope extends org.apache.ode.bpel.o.v2.OActivity {
    ...
    public org.apache.ode.bpel.o.v2.OEventHandler eventHandler;
    ...
    public final Map<String, org.apache.ode.bpel.o.v2.OPartnerLink> partnerLinks = new HashMap<String, org.apache.ode.bpel.o.v2.OPartnerLink>();
    ...
    public OScope(OProcess owner, org.apache.ode.bpel.o.v2.OActivity parent) {
        super(owner, parent);
    }
    ...
    public Variable getVisibleVariable(String varName) {
        org.apache.ode.bpel.o.v2.OActivity current = this;
        Variable variable;
        while (current != null) {
    ...
    public org.apache.ode.bpel.o.v2.OPartnerLink getLocalPartnerLink(String name) {
        return partnerLinks.get(name);
    }

    public org.apache.ode.bpel.o.v2.OPartnerLink getVisiblePartnerLink(String name) {
        org.apache.ode.bpel.o.v2.OActivity current = this;
        org.apache.ode.bpel.o.v2.OPartnerLink plink;
        while (current != null) {
            if (current instanceof OScope) {
