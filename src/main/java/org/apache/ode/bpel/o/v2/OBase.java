...
public class OBase implements Serializable {
    ...
    private final org.apache.ode.bpel.o.v2.OProcess _owner;

    public DebugInfo debugInfo;

    protected OBase(org.apache.ode.bpel.o.v2.OProcess owner) {
        _owner = owner;
        if (owner == null) {
            _id = 0;
        } else {
    ...
    public org.apache.ode.bpel.o.v2.OProcess getOwner() {
        return (org.apache.ode.bpel.o.v2.OProcess) (_owner == null ? this : _owner);
    }
