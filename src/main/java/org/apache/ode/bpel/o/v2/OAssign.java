...
import org.apache.ode.bpel.o.v2.OScope.Variable;
...
public class OAssign extends OActivity {
    ...
    public OAssign(org.apache.ode.bpel.o.v2.OProcess owner, OActivity parent) {
        super(owner, parent);
    }
    ...
    public static class Copy extends OBase {
        ...
        public Copy(org.apache.ode.bpel.o.v2.OProcess owner) {
            super(owner);
        }
    ...
    public static class Literal extends OBase implements RValue {
        ...
        public Literal(org.apache.ode.bpel.o.v2.OProcess owner, Document xmlLiteral) {
            super(owner);
            if (xmlLiteral == null)
    ...
    public static class LValueExpression extends OBase implements LValue {
        private static final long serialVersionUID = 1L;
        public org.apache.ode.bpel.o.v2.OLValueExpression expression;

        public LValueExpression(org.apache.ode.bpel.o.v2.OProcess owner, org.apache.ode.bpel.o.v2.OLValueExpression compiledExpression) {
            super(owner);
        ...
        /**
         * @see OAssign.LValue#getVariable()
         */
    ...
    public static class Expression extends OBase implements RValue {
        private static final long serialVersionUID = 1L;
        public org.apache.ode.bpel.o.v2.OExpression expression;

        public Expression(org.apache.ode.bpel.o.v2.OProcess owner, org.apache.ode.bpel.o.v2.OExpression compiledExpression) {
            super(owner);
            this.expression = compiledExpression;
        }
    ...
    public static class DirectRef extends OBase implements RValue, LValue {
        private static final long serialVersionUID = 1L;
        public DirectRef(org.apache.ode.bpel.o.v2.OProcess owner) {
            super(owner);
        }
    ...
    public static class VariableRef extends OBase implements RValue, LValue {
        ...
        public org.apache.ode.bpel.o.v2.OMessageVarType.Part headerPart;
        public org.apache.ode.bpel.o.v2.OExpression location;

        public VariableRef(org.apache.ode.bpel.o.v2.OProcess owner) {
            super(owner);
        }
        ...
        public boolean isMessageRef() {
            return variable.type instanceof org.apache.ode.bpel.o.v2.OMessageVarType && part == null && headerPart == null && location == null;
        }
        ...
        public boolean isPartRef() {
            return variable.type instanceof org.apache.ode.bpel.o.v2.OMessageVarType && part != null && location == null;
        }

        public boolean isHeaderRef() {
            return variable.type instanceof org.apache.ode.bpel.o.v2.OMessageVarType && headerPart != null && location == null;
        }
    ...
    public static class PropertyRef extends OBase implements RValue, LValue {
        private static final long serialVersionUID = 1L;
        public Variable variable;
        public org.apache.ode.bpel.o.v2.OProcess.OPropertyAlias propertyAlias;

        public PropertyRef(org.apache.ode.bpel.o.v2.OProcess owner) { super(owner); }
    ...
    public static class PartnerLinkRef extends OBase implements RValue, LValue {
          ...
          public PartnerLinkRef(org.apache.ode.bpel.o.v2.OProcess owner) { super(owner); }
